...
var z = Object.getPrototypeOf, M = Object.prototype.hasOwnProperty;
var Y = (n, o) => () => (o || n((o = {exports: {}}).exports, o), o.exports);
var j = (n, o, l, u) => {
    if (o && typeof o == "object" || typeof o == "function") for (let s of L(o)) !M.call(n, s) && s !== l && T(n, s, {
        get: () => o[s],
    ...
    (function (n, o) {
        ...
        function o(t) {
            return function (e) {
                ...
                var d = e.document, a = d.body, c = d.documentElement;
                return {
        ...
        function l(t, e, d) {
            var a, c = function () {
                ...
                return r
            }(), p = !1, f = o(t), m = f.scrollY(), i = {};

            function b() {
                var r = Math.round(f.scrollY()), h = f.height(), g = f.scrollHeight();
        ...
        return s.prototype = {
            constructor: s, init: function () {
                return s.cutsTheMustard && !this.initialised && (this.addClass("initial"), this.initialised = !0, setTimeout(function (t) {
                    t.scrollTracker = l(t.scroller, {offset: t.offset, tolerance: t.tolerance}, t.update.bind(t))
                }, 100, this)), this
            }, destroy: function () {
